...
qu'on tentait d'offrir à l'humanité une occasion de rêver
ensemble, d'espérer.
...
et on en célébrait d'autres (\og~Oh! La peintre Marquez est là!~\fg).
%
...
Le projet \nomProjet{} ratissait large.  On rêvait d'y voir toutes les formes
de savoir et de savoir faire s'interpoléniser.  On souhaitait y retrouver
toutes les disciplines qui avait su traverser les ages, et toutes les méthodes
aptent à en créer un nouveau.
La foule qui s'amassait sur le peraterre du stade était aussi éclectique que le projet lui-même:
des gens
